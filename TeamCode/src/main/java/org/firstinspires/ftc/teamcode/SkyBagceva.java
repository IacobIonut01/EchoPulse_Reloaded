...
@Autonomous(name = "SkyAutonomous YET", group = "FTC")
public class SkyBagceva extends LinearOpMode {
    ...
    private Servo platforma0;
    private Servo platforma1;

    @Override
    public void runOpMode() {
        initGyro();

        frontright = hardwareMap.dcMotor.get("MotorDF");
        backright = hardwareMap.dcMotor.get("MotorDS");
        frontleft = hardwareMap.dcMotor.get("MotorSF");
        backleft = hardwareMap.dcMotor.get("MotorSS");

        platforma0 = hardwareMap.servo.get("servo0");
        platforma1 = hardwareMap.servo.get("servo1");
